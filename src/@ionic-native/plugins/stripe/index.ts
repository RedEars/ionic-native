...
export interface StripeApplePayItem {
  label: string;
  amount: number | string;
}

export interface StripeApplePayOptions {
  merchantId: string;
  country: string;
  currency: string;
  items: StripeApplePayItem[];
}
...
export class Stripe extends IonicNativePlugin {
  ...
  /**
 * Pay with appple Pay
   * @param options {StripeApplePayOptions} Card number
   * @return {Promise<any>} returns a promise
 */
  @Cordova()
  payWithApplePay(options: StripeApplePayOptions): Promise<any> { return; }
